...
teamData = {}
for team in teams:
    teamData[team] = {'gamesPlayed': 0, 'wins': 0, 'losses': 0, 'ties': 0, 'goalsFor': 0, 'goalsAgainst': 0}
for game in games:
    home = game['home']
    away = game['away']
    ...
    teamData[home]['goalsFor'] += homeScore
    teamData[home]['goalsAgainst'] += awayScore
    teamData[away]['goalsFor'] += awayScore
    teamData[away]['goalsAgainst'] += homeScore
    if homeScore > awayScore:
        ...
        teamData[home]['ties'] += 1
        teamData[away]['ties'] += 1
